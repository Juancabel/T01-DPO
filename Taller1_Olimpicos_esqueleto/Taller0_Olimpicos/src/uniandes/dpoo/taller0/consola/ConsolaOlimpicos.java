...
{ 
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar pais de un atleta");
	...
	{ 
		...
		Atleta  esteAtleta = calculadora.buscarNombre(NombreAtleta);
		System.out.println(NombreAtleta + " es de " + esteAtleta.darPais().darNombre());
	}
	/**
